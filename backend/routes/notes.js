...
router.post(
  ...
  [
    ...
    body(
      "description",
      "Enter a valid description must be atleast 5 characters"
    ).isLength({ min: 5 }),
  ],
  async (req, res) => {
    try {
...
//ROute 3 update a note using put '/api/auth/updatenote login reqiured
...
//ROute 3 delete a note using delete '/api/auth/updatenote login reqiured
